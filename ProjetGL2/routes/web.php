...
//Store : 
Route::post('/a_scolarite', [DemandeController::class, 'store1']);
// Relevé de notes
Route::post('/r_note', [DemandeController::class, 'store2']);
// Convention de stage
Route::post('/c_stage', [DemandeController::class, 'store3']);
// Attestation de reussite
Route::post('/a_reussite', [DemandeController::class, 'store4']);
