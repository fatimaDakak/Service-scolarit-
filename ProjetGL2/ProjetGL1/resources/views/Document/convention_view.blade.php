...
<body>
    <table>
        ...
        <p>T&eacute;l&nbsp;: <strong>{{$demande->tele}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>Email:&nbsp;<strong>{{$demande->adressMail}}</strong></p>
        <p>Repr&eacute;sent&eacute;e par Monsieur <strong>{{$demande->representant}} </strong>en qualit&eacute; <strong>Le Chef de la division des Syst&egrave;me d'Information</strong></p>
        <p>Ci-apr&egrave;s d&eacute;nomm&eacute;e <strong>L&rsquo;ENTREPRISE</strong></p>
        <p>&nbsp;</p>
        <p><strong>Article 1 : Engagement</strong></p>
        <p><strong>L&rsquo;ENTREPRISE</strong> accepte de recevoir &agrave; titre de stagiaire&nbsp;<strong>{{$etudiant->Nom}} {{$etudiant->Prenom}}</strong> &eacute;tudiant de la fili&egrave;re <strong> &laquo; {{$etudiant->filiere}} &raquo; </strong>de l&rsquo;ENSA de T&eacute;touan, Universit&eacute; Abdelmalek Essa&acirc;di (T&eacute;touan), pour une p&eacute;riode du <strong>{{$demande->periode}}</strong></p>
        ...
        <p>Pour accompagner le Stagiaire durant son stage, et ainsi instaurer une v&eacute;ritable collaboration L&rsquo;ENTREPRISE/Stagiaire/Etablissement, L&rsquo;ENTREPRISE d&eacute;signe Mme/Mr <strong>{{$demande->encadrantEntreprise}}</strong> encadrant(e) et parrain(e), pour superviser et assurer la qualit&eacute; du travail fourni par le Stagiaire.</p>
        <p>L'Etablissement d&eacute;signe <strong>{{$demande->encadrantEcole}} </strong>en tant que tuteur qui procurera une assistance p&eacute;dagogique</p>
        <p><strong>&nbsp;</strong></p>
        <p><strong>Article 4 : Programme:</strong></p>
        <p>Le th&egrave;me du stage est: <strong>&laquo;&nbsp;{{$demande->themeDeStage}}.&nbsp;&raquo;</strong></p>
