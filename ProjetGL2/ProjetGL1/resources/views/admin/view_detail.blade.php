        ...
        <div class="content w-full mb-40">
            ...
            <form action="" method="" enctype="">
                <div class="userDet">
                    ...
                    <div class="input-box">
                        <label for="">Voir le document Envoyé:</label>
                        <a href="{{asset('documents/'. $data['filename'])}}" class="visit d-block fs-14 rad-6 bg-blue c-white w-fit btn-shape">Document</a>
                    </div>
                    @endif
                </div>
                </form>
